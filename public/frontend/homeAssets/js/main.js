  ...
  */
  ...
  function primaryMenuSetup() {
    ...
    $(".menu-item-has-children > ul").before(
      '<i class="fa fa-plus m-dropdown" class="m-dropdown"></i>'
    );
  ...
  function accordianSetup() {
    if ($.exists(".single-accordian")) {
      ...
      $(".single-accordian:first-child")
        ...
        .addClass("active"); // Active class Added
  ...
  $(document).on("ready", function () {
    $(".st-accent-color").on("click", function () {
      ...
      $("body")
        .removeClass(
          "st-green st-blue st-indigo st-purple st-orange st-red st-teal st-yellow"
        )
        .addClass(colorClass);
    });
    $(".st-accent-color").on("click", function () {
